  ...
  return (
    <header className="flex h-16 md:h-20 items-center justify-between bg-background px-4 md:px-8 pt-2 md:pt-4 pb-2 z-10 relative">
      <div className="flex items-center gap-2 md:gap-3">
        ...
        <Link href="/dashboard/settings" className="rounded-full ring-1 ring-white/20 hover:ring-primary/50 transition-all cursor-pointer overflow-hidden flex ml-2 outline-none focus:outline-none">
          <Avatar className="h-7 w-7 md:h-8 md:w-8 bg-primary/20 text-primary">
            {coachAvatar ? (
